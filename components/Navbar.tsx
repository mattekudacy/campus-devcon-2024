...
import pyconLogo from "@/assets/campus-devcon-2024.png";
...
export const AdminNavbar = () => {
  ...
  return (
    <nav className="flex bg-gradient-to-r from-[#91b710] via-[#8f4ac7] via-[#e0c650] to-[#e16c29] drop-shadow-xl p-5 justify-between dark:bg-[#fffff]">
